...
class Student: public Person{//creating a Student class which will inherit the public person class;
...
public: //public access modifier for graduated class
    ...
    Graduated(string n,int a,string g, string i,int credit,string sub,float cg):Student(n,a,g,i,credit,sub){ //parameterized constructor for graduated class
    cgpa = cg;
    }
...
class Employee: public Person{ //creating a Employee class which will inherit the person class
...
public:
    ...
    Officer(string n,int a,string g,int sal,int hour,string r):Employee(n,a,g,sal,hour){ //Parameterized constructor of the Officer class.
     raank = r;
    }
...
public:
    ...
    Faculty(string n,int a,string g,int sal,int hour, string d,string p):Employee(n,a,g,sal,hour){ // Parameterized constructor for the Employee class;
    department = d;
    position = p;
    }
...
cout<<"For Graduated Student: "<<endl;

Graduated g1;
g1.graduatedGetInfo();
g1.gradutedShowInfo();
/*
cout<<"For faculty:"<<endl;
