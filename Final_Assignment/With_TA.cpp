...
class TA: public Student,public Faculty{ // TA class which will inherit both student class and faculty class
protected:
    string semister;
public:
    TA():Student(),Faculty(){ //empty constructor for the TA class
    semister="invalid semister.";
     cout<<"TA Class."<<endl;}
    TA(string n,int a,string g,string i,int credit,string sub,int sal,int hour,string d,string p,string s):Student(n,a,g,i,credit,sub),Faculty(n,a,g,sal,hour,d,p),Person(n,a,g){
    semister = s; //Parameterized constructor for the TA class.

    }

    void setSemister(string s){ //setter method for semister variable;
    }
    string getSemister(){return semister;} //getter method for semister variable;

    void TAgetInfo(){ //creating a method which will be used for inputing informations.
       string  d,s;
       int sal,hour;
       studentGetInfo();
       cout<<"What is your semister: ";
       cin>>s;
       cout<<"What is your department: ";
       cin>>d;
       cout<<"What is your Salary: ";
       cin>>sal;
       cout<<"How many hour you work: ";
       cin>>hour;
       setSemister(s);
       setDepartment(d); //setter method for the informations
       setSalary(sal);
       setWorkhour(hour);
    }
    void TAshowInfo(){ //creating a method for displaying the info.
       studentShowInfo();
       cout<<"Semister: "<<getSemister()<<endl;
       cout<<"Department: "<<getDepartment()<<endl;
